...
import com.canal.dao.impl.AbonneDao;
import com.canal.dao.impl.AdresseDao;
import com.canal.dao.impl.MouvementDao;
...
public class TestRunner {
    ...
    public void modificationAdresse() {
        ...
        when(abonneDao.getAbonneById(1)).thenReturn(abonne);
